========================================================================
    KONSOLENANWENDUNG: ChangeDetection_PBAS-Projektübersicht
========================================================================

Diese ChangeDetection_PBAS-Anwendung wurde vom Anwendungs-Assistenten 
für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, 
aus denen Ihre ChangeDetection_PBAS-Anwendung besteht.


ChangeDetection_PBAS.vcxproj
...
ChangeDetection_PBAS.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    ...
    (PCH-Datei) mit dem Namen "ChangeDetection_PBAS.pch und eine 
